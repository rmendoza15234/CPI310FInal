let express,exphbs,bcrypt,cookieParser,sqlite3,open,grantAuthToken,lookupUserFromAuthToken;_6c1‍.x([["dbPromise",()=>dbPromise]]);_6c1‍.w("express",[["default",["express"],function(v){express=v}]]);_6c1‍.w("express-handlebars",[["default",["exphbs"],function(v){exphbs=v}]]);_6c1‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_6c1‍.w("cookie-parser",[["default",["cookieParser"],function(v){cookieParser=v}]]);_6c1‍.w("sqlite3",[["default",["sqlite3"],function(v){sqlite3=v}]]);_6c1‍.w("sqlite",[["open",["open"],function(v){open=v}]]);_6c1‍.w("./auth",[["grantAuthToken",["grantAuthToken"],function(v){grantAuthToken=v}],["lookupUserFromAuthToken",["lookupUserFromAuthToken"],function(v){lookupUserFromAuthToken=v}]]);/*
...
*/
 ...
 //importing express and handlebars
 ...
 //importing sqlite
       ...
       const dbPromise = _6c1‍.a("open",open)({ //exporting dbPromise to use in auth.js
    filename: "data.db",
    driver: _6c1‍.a("sqlite3",sqlite3).Database,
});;_6c1‍.j(["dbPromise"]);

const app = _6c1‍.a("express",express)(); //express object used to interact with express functionalities
const port = 8080;

app.engine("handlebars", _6c1‍.a("exphbs",exphbs)()); //handlebars setup
app.set("view engine", "handlebars");

app.use(_6c1‍.a("express",express).urlencoded({ extended: false })); //middleware to parse the request body
app.use("/static", _6c1‍.a("express",express).static(__dirname + "/static")); //middleware to register the static content
app.use(_6c1‍.a("cookieParser",cookieParser)()); //middleware to use cookie-parser
...
app.use(async (req, res, next) => {
    ...
    try
    {
        const user = await _6c1‍.a("lookupUserFromAuthToken",lookupUserFromAuthToken)(authToken);
...
app.get("/", async (req, res) => {
    ...
    _6c1‍.g.console.log("messages", messages);
...
app.post("/register", async (req, res) => {
    ...
    const passwordHash = await _6c1‍.a("bcrypt",bcrypt).hash(password, 10); //hashes the password
    ...
    try
    {
        ...
        const authToken = await _6c1‍.a("grantAuthToken",grantAuthToken)(user.id); //keeps the user logged in if already registered
...
app.post("/login", async (req, res) => {
    ...
    try
    {
        ...
        const passwordsMatch = await _6c1‍.a("bcrypt",bcrypt).compare(password, existingUser.password); //compares the entered password to the user's password
        ...
        const authToken = await _6c1‍.a("grantAuthToken",grantAuthToken)(existingUser.id);
        res.cookie("authToken", authToken); //sets authToken as a cookie
...
app.post("/logout", (req, res) => { //logout function
    ...
    _6c1‍.g.console.log(req.user.username, "has logged out");
...
const setup = async () => { //setup function
    ...
    app.listen(port, () => { //starts the web application on localhost:8080
        _6c1‍.g.console.log("listening on port", port);
    });
};
